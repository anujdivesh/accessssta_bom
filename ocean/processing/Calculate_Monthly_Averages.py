        ...
        self.config = \
            {'reynolds':{
             ...
             'msla':{
                ...
                'input_dir': os.path.join(sys_config.dataDir['msla'],'grids/daily/%(year)04d/%(month)02d'),
                #'input_filename': 'nrt_global_allsat_msla_h_%(year)04d%(month)02d%(day)02d_%(year)04d%(month)02d%(day)02d.nc',
                'input_filename': 'nrt_global_allsat_phy_l4_%(year)04d%(month)02d%(day)02d_%(year)04d%(month)02d%(day)02d.nc',

        ...
        if not dataset in self.product_list:
            ...
            for avg_period in [1, 3, 6, 12]:
                for month in range(1, 12 + 1):
                    ...
                    decile_edge_values, data_mask = self.calculate_decile_edges(input_files, self.variable_name)
                    ...
                    for input_file in input_files:
                        ...
                        for varName1, var1 in referenceNc.variables.iteritems():
                            if varName1 in ['lat', 'lon']:
                                ...
                                cat_masked=np.ma.masked_array(cat,data_mask)
                                ...
                                dataVar2.setncattr('units', 'Decile Plotting Categories')
                                dataVar2[:,:,] = cat_masked[:,:]
